...
class WaveNetModel(object):
	...
	def _create_generator(self, input_batch, gc_batch,
						 lc_batch):
	...
	def loss(self,
		...
		with tf.name_scope(name):
			...
			# Not necessary to encode LC batch
			raw_output = self._create_network(network_input, gc_embedding, lc_batch)
